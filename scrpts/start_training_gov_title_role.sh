...
#    --model_name bert_for_ner \
#    --schedule deploy \
#    --model_resume_path /search/odin/yyk/workspace/AiSpace/save/test_bert_for_ner_gov_title__role_119_6 \
#    --config_name gov_title_role \
#    --config_dir ./configs/custom \
#    --gpus 0 \
#    > err.log 2>&1 &
...
#DEPLOY_PATH="/search/odin/yyk/workspace/AiSpace/save/test_bert_for_ner_gov_title__role_119_6/deploy/BertNerWithTitleStatusService/20210218111157_16691B"
