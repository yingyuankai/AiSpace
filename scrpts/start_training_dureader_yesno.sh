...
#    --model_name bert_for_classification \
#    --schedule deploy \
#    --model_resume_path /search/odin/yyk/workspace/AiSpace/save/test_bert_for_classification_dureader__yesno_119_3 \
#    --config_name dureader_yesno \
#    --config_dir ./configs/qa \
#    --gpus 0 1 \
#    > err.log 2>&1 &
...
#DEPLOY_PATH="save/test_bert_for_classification_dureader__yesno_119_3/deploy/BertTextClassificationService/20201030101511_312D5D"
