...
#    --model_name bert_for_ner \
#    --schedule deploy \
#    --model_resume_path /search/odin/yyk/workspace/AiSpace/save/test_bert_for_ner_gov_title__trigger_119_25 \
#    --config_name gov_title_trigger \
#    --config_dir ./configs/custom \
#    --gpus 0 \
#    > err.log 2>&1 &
...
#DEPLOY_PATH="/search/odin/yyk/workspace/AiSpace/save/test_bert_for_ner_gov_title__trigger_119_25/deploy/BertNerService/20210108151039_EF0A31"
