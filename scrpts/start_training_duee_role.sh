...
#    --schedule deploy \
#    --model_resume_path /search/odin/yyk/workspace/AiSpace/save/role_bert_for_role_ner_lstc_2020__DuEE_role_119_28 \
#    --config_name DuEE_role \
#    --config_dir ./configs/2020_LSTC \
#    --gpus 0 \
#    > err.log 2>&1 &
...
#DEPLOY_PATH="/search/odin/yyk/workspace/AiSpace/save/role_bert_for_role_ner_lstc_2020__DuEE_role_119_28/deploy/RoleBertNerService/20210409165115_A05D1F"
