...
@BaseTransformer.register("lstc_2020/DuEE_trigger_as_classify")
class DuEETriggerAsClassifyTransformer(BaseTransformer):
    def __init__(self, hparams, **kwargs):
        super(DuEETriggerAsClassifyTransformer, self).__init__(hparams, **kwargs)
